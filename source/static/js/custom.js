...
// 进行 fetch 请求
fetch('https://api.nsmao.net/api/ip/query?key=38OEwcJDe916pR7UzI2oaLEgVS') //申请key:https://api.nsmao.net
.then(response => {
if (!response.ok) {
...
return;
 ...
 let dist = getDistance(120.431663, 37.365510, ipLocation.data.lng, ipLocation.data.lat); // 修改自己的经度（121.413921）纬度（31.089290）
